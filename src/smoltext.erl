...
makeMenuBar() ->
  Menu = wxMenuBar:new(),
  %MenuCategories = [File = wxMenu:new(), Edit = wxMenu:new(), Help = wxMenu:new()],
  ...
  %[wxMenuBar:append() || Category <- Categories],
  %[wxMenuBar:append(Menu, [H|_], ) || Category <- Categories],
  %File = wxMenu:new(),
  ...
  %wxMenuBar:append(Menu, FileMenu, "File"),
